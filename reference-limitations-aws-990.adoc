---
sidebar: sidebar
permalink: reference-limitations-aws-990.html
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Amazon Web Services. Be sure to also review link:reference-limitations-990.html[Limitations for Cloud Volumes ONTAP 9.9.0 in all cloud providers].
